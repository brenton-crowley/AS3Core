package au.com.dtdigital.core.utils {
	...
	public class NumberUtil {
		 ...
		 * 
		 * @param num:Number  The number to be rounded
		 * @param places:int  The number of decimal places to round to (optional)
		 * 
		 * @return Number
		 * 
		 */
		 ...
		 * 
		 * @param latitudeDegrees:Number  The true longitude to be converted
		 * @param mapWidth:Number  The width of your map
		 * 
		 * @return Number
		 * 
		 */
