package au.com.dtdigital.core.utils {
	...
	public class StringUtil {
		 ...
		 * @param count:uint  The number of times to repeat the string
		 * @param separator:String (optional)  The string to add after each repeat
		 * 
		 * @return String
		 * 
		 */
		public static function repeat(string:String = "", count:uint = 0, separator:String = ""):String {
			var result:String = "";
			if (count > 0) {
				for(var i:uint = 0; i < count; i++) {
					result = result.concat(string + separator);
				}
			}
			else {
		 ...
		 * 
		 * @param email:String  The email that need to be validated. 
		 * 
		 * @return Boolean
		 * 
		 */
		...
		/*
		 * Replaces all instances of a given substring in a string.
		 * 
		 * @param string:String  The string to be edited. 
		 * @param find:String  The substring to replace
		 * @param replace:String  The replacement 
		 * @param ignoreCase:Boolean  Ignore case (optional)
		 * 
		 * @return String
		 * 
		 */
		
		public static function replaceString(string:String, find:String, replace:String, ignoreCase:Boolean = false):String {
		...
		/*
		 * Add and remove elements in a string (as opposed to StringUtil.replaceString, splice will only replace the first instance)
		 * 
		 * @param string:String  The string to be edited. 
		 * @param startIndex:uint Index at which to start changing the string.
	 	 * @param deleteCount:uint The number of old character elements to remove.
	    ...
	    public static function splice(string:String, startIndex:uint, deleteCount:uint = 0, value:* = null):String {
			var a:Array = toArray(string) ;
		...
		/*
		 * Returns an array representation the given string
		 * 
		 * @param string:String  The string to be arrayed 
	    ...
	    public static function toArray(string:String, separator:String = ""):Array {
		 ...
		 * 
		 * @param string:String  The string to be edited. 
		 * @param delim:String  The character that is to be removed from the string being passed in. 
		 * 
		 * @return String
		 * 
		 */

		public static function stripCharacter(string:String, delim:String):String {
			var splitArray:Array = string.split(delim);
			var result:String = "";
			var len:int = splitArray.length;
		 ...
		 * 
		 * @param filename:String  The filename to be extracted. 
		 * 
		 * @return String
		 * 
		 */
		...
		/*
		 * Returns everything after the last period
		 * 
		 * @param filename:String  The filename of the extension to be extracted. 
		 * 
		 * @return String
		 * 
		 */
	...
	/**
	* 	The following String Utilities methods by Ryan Matsikas, Feb 10 2006
	*
